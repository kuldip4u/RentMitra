...
public class TouchImageView extends ImageView {
	...
	private static final float SUPER_MAX_MULTIPLIER = 1.50f;
	...
	public interface ImageListener {
		public void onImageSet(Drawable d);
	}

	private ImageListener imageListener;

	public void setOnImageListener(ImageListener l) {
		imageListener = l;
	}
	...
	public void setImageResource(int resId) {
		...
		if (null != imageListener) {
			imageListener.onImageSet(getDrawable());
		}
	}
	...
	/**
	 * Get the current image start pan position
	 * 
	 * @return current image scroll position
	 */
	public PointF getCurrentStart() {
		return transformCoordBitmapToTouch(0, 0);
	}

	/**
	 * Get the current image end pan position
	 * 
	 * @return current image scroll position
	 */
	public PointF getCurrentEnd() {
		return transformCoordBitmapToTouch(getDrawable().getIntrinsicWidth(), getDrawable().getIntrinsicHeight());
	}
	...
	private class GestureListener extends GestureDetector.SimpleOnGestureListener {
		...
		public boolean onSingleTapUp(MotionEvent e) {
			if (touchImageViewListener != null) {
				touchImageViewListener.onSingleTapUp(e, transformCoordTouchToBitmap(e.getX(), e.getY(), true), getDrawable()
						.getIntrinsicWidth(), getDrawable().getIntrinsicHeight());
			}
	...
	public interface OnTouchImageViewListener {
		...
		public void onSingleTapUp(MotionEvent e, PointF touchedPoint, float imgWidth, float imgHeight);
	}
